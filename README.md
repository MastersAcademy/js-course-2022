...
Masters Academy «JavaScript» course project for season 2022/2023
-----------------------------------------------------------------------


# Terms and conditions
--------------------
 * Цей документ визначає та декларує чим є курси з «JavaScript» які проводить Masters Academy в 2022-2023 рр.
 * Курси проводяться Masters Academy, на платній добровільній основі.
 * Метою проведення курсів є допомога зацікавленим особам у вивченні мови програмування JavaScript.
...
# [Hometasks](https://github.com/MastersAcademy/js-course-2022/issues/)
