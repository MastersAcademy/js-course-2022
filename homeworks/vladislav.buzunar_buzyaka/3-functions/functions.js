...
const totalWeightOil = getWeight(OIL, 0, numOilBank);
const totalWeightWater = getWeight(WATER, 0, numWaterBank);
const totalWeightMercury = getWeight(MERCURY, 0, numMercuryBank);
